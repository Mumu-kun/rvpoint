...
elif [[ "$TARGET_NAME" != test_* && "$TARGET_NAME" != rvv_test && "$TARGET_NAME" != benchmark && "$TARGET_NAME" != benchmark_* && "$TARGET_NAME" != pipeline_export && "$TARGET_NAME" != pipeline_fast_export && "$TARGET_NAME" != pipeline_rvv_ultra_fast && "$TARGET_NAME" != pipeline_rvv_turbo && "$TARGET_NAME" != pipeline_3d_turbo && "$TARGET_NAME" != scalar_25d_baseline && "$TARGET_NAME" != ablation_bench && "$TARGET_NAME" != neighbor_search_sor_bench && "$TARGET_NAME" != pipeline_compare_bench && "$TARGET_NAME" != pcl_standalone_pipeline ]]; then
