...
* **Generated Output Directories**:
  * [output/pcd_compressed_pipeline/by_frame/](file:///e:/FahadProject/rvpoint/output/pcd_compressed_pipeline/by_frame/): Per-frame stage PCD files (`00_input.pcd`, `01_downsampled.pcd`, `04_ransac_inliers.pcd`, `05_ground_plane_removed.pcd`).
  * [output/pcd_compressed_pipeline/by_stage/](file:///e:/FahadProject/rvpoint/output/pcd_compressed_pipeline/by_stage/): Stage-grouped PCD files across frames.
...
Use [export_mcap.py](file:///e:/FahadProject/rvpoint/scripts/export_mcap.py) to package the pipeline stage `.pcd` files into a single `.mcap` timeline file.
...
2. Select your generated file:
   [output/rvpoint_pipeline.mcap](file:///e:/FahadProject/rvpoint/output/rvpoint_pipeline.mcap)
