...
### Ablation A: Voxel Grid Downsampling ([voxel_grid_downsamp.cpp](src/voxel_grid_downsamp.cpp))
...
### Ablation B: Spatial Neighbor Search Engines ([pointer_octree.h](src/pointer_octree/pointer_octree.h))
...
### Ablation C: Statistical Outlier Removal (SOR) Spatial Index Variants ([statistical_outlier_removal.cpp](src/statistical_outlier_removal.cpp))
...
### Ablation D: RANSAC Plane Fitting Iteration Scaling ([ransac_plane.cpp](src/ransac_plane.cpp))
...
*Benchmark binary: [tests/integration/test_scaling.cpp](tests/integration/test_scaling.cpp)*
...
### C. Ablation E: Euclidean Clustering Optimization ([euclidean_clustering.cpp](src/euclidean_clustering.cpp))
...
* **Execution Harness:** [`src/tools/pipeline_stage_comparison.cpp`](src/tools/pipeline_stage_comparison.cpp)
...
* JSON: [`output/comparison/comparison_metrics.json`](output/comparison/comparison_metrics.json)
* CSV: [`output/comparison/comparison_metrics.csv`](output/comparison/comparison_metrics.csv)
