...
**Artifacts Generated:**
- Consolidated Results: [`output/profiling_results/consolidated_profiling_results.json`](output/profiling_results/consolidated_profiling_results.json)
- Summary CSV: [`output/profiling_results/summary_results.csv`](output/profiling_results/summary_results.csv)
