...
int main() {
    ...
    // 1. Generate Data: Cluster at (0,0,0) + Random Outliers
    ...
    // Both methods preserve order of original points (stable filter logic),
    // so we can compare index-by-index directly.
