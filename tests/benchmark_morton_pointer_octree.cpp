#include "morton_pointer_octree/morton_pointer_octree.h"
...
int main(int argc, char** argv) {
    ...
    std::printf("============================================================\n");
    std::printf("  RVPoint Morton-Sorted Global SoA Octree PCD Benchmark\n");
    std::printf("============================================================\n\n");
    ...
    // Test a wide range of leaf sizes (from 8 to 128)
