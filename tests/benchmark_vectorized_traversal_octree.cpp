#include "vectorized_traversal_octree/vectorized_traversal_octree.h"
...
int main(int argc, char** argv) {
    ...
    std::printf("============================================================\n");
    std::printf("  RVPoint Vectorized Traversal Octree PCD Benchmark\n");
    std::printf("============================================================\n\n");
    ...
    // Test a wider range of leaf sizes (from 8 to 128)
    const int leaf_sizes[] = {8, 16, 32, 64, 128};
    ...
    for (int leaf_size : leaf_sizes) {
        ...
        VectorizedTraversalOctree octree;
